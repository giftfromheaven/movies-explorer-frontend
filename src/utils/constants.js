...
export const HERE_WILL_BE_YOUR_SAVED_MOVIES =
  "Здесь появятся ваши сохраненные фильмы.";
export const HERE_WILL_BE_YOUR_MOVIES = "Здесь появятся ваши фильмы.";
export const SHORT_MOVIES_NOT_FOUND =
  "Короткометражных фильмов по запросу не найдено.";
export const NO_MOVIES_WITH_LAST_QUERY =
  "По последнему запросу ничего не найдено.";
